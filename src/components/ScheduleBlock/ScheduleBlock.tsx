                            ...
                            <li key={scheduleData.id}>
                                <div className={styles.schedule_item}>
                                    <div className={styles.schedule_date_time}>
                                        <span className={styles.schedule_date}>{scheduleData.date}</span>
                                        <span className={styles.schedule_time}>{scheduleData.time}</span>
                                    </div>
                                    <div className={styles.schedule_description_block}>
                                        <span className={styles.schedule_title}>{scheduleData.title}</span>
                                        <span className={styles.schedule_description}>{scheduleData.description}</span>
                                    </div>
                                </div>
                            </li>
